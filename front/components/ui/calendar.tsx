...
function CalendarDayButton({
  ...
  const isChecked = modifiers?.checked
  ...
  return (
    ...
    >
      ...
      {isChecked ? (
        <CircleCheck className="pointer-events-none absolute right-1 top-1 flex h-4 w-4 items-center justify-center rounded-full bg-emerald-950 text-emerald-200 text-[0.6rem] font-bold"/>
      ) : null}
    </Button>
  )
}
